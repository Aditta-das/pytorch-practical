# import
import torch
import torch.nn as nn # All nueral network modules, nn.Linear, nn.Conv2d, BatchNorm, Loss Function
...
class LeNet(nn.Module):
	def __init__(self):
		...
		self.conv2 = nn.Conv2d(in_channels=6, out_channels=16, stride=(1, 1), kernel_size=(5, 5))
